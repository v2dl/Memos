...
![Task 2-1-1](./Images/Task-2-1-1.png "Task 2-1-1")

![Task 2-1-2](./Images/Task-2-1-2.png "Task 2-1-2")


#### 以API Server方式启动lmdeploy，开启 W4A16量化，调整KV Cache的占用比例为0.4，分别使用命令行客户端与Gradio网页客户端与模型对话
![Task 2-2-1](./Images/Task-2-2-1.png "Task 2-2-1")

![Task 2-2-2](./Images/Task-2-2-2.png "Task 2-2-2")


#### 使用W4A16量化，调整KV Cache的占用比例为0.4，使用Python代码集成的方式运行internlm2-chat-1.8b模型
![Task 2-3-1](./Images/Task-2-3-1.png "Task 2-3-1")

![Task 2-3-2](./Images/Task-2-3-2.png "Task 2-3-2")
